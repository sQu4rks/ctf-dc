"""
    ...
    File adopted from https://github.com/movinalot/intersight-rest-api/blob/master/intersight_auth.py
"""
...
def get_authenticated_aci_session(username, password, base_url):
    s = requests.Session()
    payload = {
        "aaaUser": {
            "attributes": {
